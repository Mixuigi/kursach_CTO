...
class Request(models.Model):
    cat = (('грузовик больше 3.5т', 'грузовик больше 3.5т'),
           ('грузовик меньше 3.5т', 'грузовик меньше 3.5т'),
           ('электрокар', 'электрокар'),
           ('гибридное авто', 'гибридное авто'),
           ('автомобиль с ДВС', 'автомобиль с ДВС'))
    ...
    stat = (
        ('В ожидании', 'В ожидании'), ('Одобрено', 'Одобрено'), ('Ремонт', 'Ремонт'),
        ('Отремонтировано', 'Отремонтировано'),
        ('Можно забирать', 'Можно забирать'))
    status = models.CharField(max_length=50, choices=stat, default='В ожидании', null=True)
