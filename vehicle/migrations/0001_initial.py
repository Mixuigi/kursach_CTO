# Generated by Django 3.2.7 on 2021-12-02 18:30
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('category', models.CharField(choices=[('двухколесный автомобиль с коробкой передач', 'двухколесный автомобиль с коробкой передач'), ('двухколесный транспорт без коробки передач', 'двухколесный транспорт без коробки передач'), ('трехколесный', 'трехколесный'), ('четырехколесный', 'четырехколесный')], max_length=50)),
                ...
                ('status', models.CharField(choices=[('В ожидании', 'В ожидании'), ('Одобрено', 'Одобрено'), ('Ремонт', 'Ремонт'), ('Отремонтировано', 'Отремонтировано'), ('Можно забирать', 'Можно забирать')], default='В ожидании', max_length=50, null=True)),
